...
# AI 接口专用 HTTP 会话（定制点）
# ============================================================
# 这台 Windows 的系统代理（IE 设置）指向局域网某台机器的 :7897（2026-07-30 局域网换段后是
# 192.168.1.2:7897 / mac-mini，此前是 192.168.3.5:7897），requests 在 Windows
    ...
    def wx_send_ai(self, chat, message):
        ...
        try:
            ...
            try:
                ...
                log(level="ERROR", message=f"wechat_checkin plugin error: {plugin_error}")
